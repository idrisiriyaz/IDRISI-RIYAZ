...
<div class="col-sm-12">
    ...
    <?php
        ...
        //printing each location we have in our db.
        foreach($result as $locations){
            echo'<div class="col-sm-3 mar-bot" >
                    <div class="card" onclick="go_to_cars('.$locations["loc_id"].')">
...
<script>
    //following function creates a cookie of selected location and redirects to car page.
    function go_to_cars(id){
        var now = new Date();
        now.setDate( now.getDate() + 1 );
        document.cookie = "loc_id="+id+";expires="+now.toUTCString();
